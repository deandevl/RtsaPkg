...
#'
#' @description A wrapper around the riingo::riingo_prices()) for returning a data frame of historic stock prices.
...
#'
#' @return A data frame with historic \dQuote{Date}'s along with stock price related variables.
#'
#' @author Rick Dean
#'

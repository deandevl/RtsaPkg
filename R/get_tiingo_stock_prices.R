...
#'
#' @export
get_tiingo_stock_prices <- function(symbols = "IBM", periodicity = "weekly", from = "2019-01-01", to = "2019-12-31"){
  if(periodicity %in% c("daily", "weekly", "monthly", "annually")){
    ...
    stop("Acceptable values for periodicity are 'daily', 'weekly', 'monthly', 'annually'")
  }
}

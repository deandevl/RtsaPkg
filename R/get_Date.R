#' Function create a Date time object(s) for representing calendar dates
#'
#' @description The function is just a simple wrapper around the
...
#'   strings of time in the assumed ISO 8601 format of \dQuote{YYYY-mm-dd}.
